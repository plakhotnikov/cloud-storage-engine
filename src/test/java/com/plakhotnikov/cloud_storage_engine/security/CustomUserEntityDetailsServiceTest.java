...
public class CustomUserEntityDetailsServiceTest {
    ...
    void testLoadUserByUsername() {
        UserEntity userEntity = (UserEntity) customUserDetailsService.loadUserByUsername("abc@abc.ru");
        assertAll(
                () -> assertEquals(userEntity.getUsername(), "abc@abc.ru"),
                () -> assertEquals(userEntity.getId(), 1L),
                () -> assertTrue(passwordEncoder.matches("123", userEntity.getPassword()))
        );
    }
}
